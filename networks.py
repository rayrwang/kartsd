...
class VSNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(9472, 500)
        self.fc2 = nn.Linear(500, 12120)

        # ResNet and FPNs
        self.n1 = nn.ModuleDict(dict(
            conv1=nn.Conv2d(3, 16, kernel_size=(5, 7), stride=(3, 2), padding=(5, 4), bias=False),
            pool1=nn.MaxPool2d(kernel_size=3, stride=(1, 2)),
            pool=nn.MaxPool2d(kernel_size=2, stride=2),
            skip1=nn.Conv2d(16, 32, kernel_size=1, stride=1, bias=False),
            conv2=nn.Conv2d(16, 32, kernel_size=3, stride=2, padding=1, bias=False),
            ...
            conv4=nn.Conv2d(32, 64, kernel_size=3, stride=2, padding=1, bias=False),
            ...
            conv6=nn.Conv2d(64, 128, kernel_size=3, stride=2, padding=1, bias=False),
        ...
        self.n2 = nn.ModuleDict(dict(
            conv1=nn.Conv2d(3, 16, kernel_size=(5, 6), stride=(1, 2), padding=(5, 11), bias=False),
    ...
    def forward(self, x1, x2, x3):
        ...
        x1 = n1.act(n1.pool1(n1.conv1(x1)))
        c1 = x1.clone()
        # print(x1.shape)
        ...
        x2 = n2.act(n2.pool1(n2.conv1(x2)))
        c1 = x2.clone()
        # print(x2.shape)
        ...
        x3 = n3.act(n2.pool1(n3.conv1(x3)))
        c1 = x3.clone()
        # print/(x3.shape)
